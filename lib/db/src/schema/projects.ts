import { pgTable, text, serial, timestamp, real, integer, boolean, jsonb, uniqueIndex } from "drizzle-orm/pg-core";
...
export const projectsTable = pgTable("projects", {
  ...
  uniqueIndex("projects_access_token_unique").on(table.accessToken),
]);
