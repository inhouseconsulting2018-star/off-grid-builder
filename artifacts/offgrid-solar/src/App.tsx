...
import { TermsPage, PrivacyPage, RefundPage, DisclaimerPage } from "@/pages/legal";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/promo-codes" component={AdminPromosPage} />
      <Route path="/admin/promo-codes" component={AdminPromosPage} />
